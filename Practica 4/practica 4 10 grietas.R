...
area35 = as.numeric(largos[1, ])

area50 = as.numeric(largos[2, ])

area65 = as.numeric(largos[3, ])

area80 = as.numeric(largos[4, ])

area90 = as.numeric(largos[5, ])

area100 = as.numeric(largos[6, ])


png("p4_k60.png")

lbls = c("35*35", "50*50", "65*65", "80*80", "90*90", "100*100")

boxplot(area35, area50 , area65, area80, area90, area100, col=c(30,18,19, 69, 98, 33, 10), names = lbls, ylab="Distancia de la grieta", xlab="área", ylim = c(1, 130))
