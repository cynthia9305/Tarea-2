...
for (tiempo in 1:tmax) {
  ...
  if (dim(aS)[1] > 0) {
    ...
    points(aS$x, aS$y, pch=15, col="darkseagreen1", bg="darkseagreen1")
    
  }
  
  if (dim(aI)[1] > 0) {
    
    points(aI$x, aI$y, pch=16, col="deeppink1", bg="deeppink1")
    
  }
  
  if (dim(aR)[1] > 0) {
    
    points(aR$x, aR$y, pch=17, col="deepskyblue4", bg="deepskyblue4")
